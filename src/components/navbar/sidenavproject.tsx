...
export const SideNavProject = ({ onClose }: SideNavProjectProps) => {
  ...
  // Conditional query using tRPC to avoid no user error if not signed-in
    ...
    return(
      <div id="project-side-bar-container" className="flex flex-col h-3/4 md:h-full w-full items-center gap-y-4 border overflow-hidden  bg-white border-slate-300 rounded-lg mx-2 md:mx-2 p-4 mb-16 md:mb-40 shadow-md" style={{ backdropFilter: 'blur(10px)' }}> 
